    ...
    if existing:
        ...
        _apply_versioned_update(
            ...
            dict(
                ...
                overall_discount_type=q_in.overall_discount_type,
                overall_discount_percent=q_in.overall_discount_percent,
                overall_discount_amount=q_in.overall_discount_amount,
    ...
    if existing:
        ...
        _apply_versioned_update(
            ...
            dict(
                ...
                overall_discount_type=inv_in.overall_discount_type,
                overall_discount_percent=inv_in.overall_discount_percent,
                overall_discount_amount=inv_in.overall_discount_amount,
